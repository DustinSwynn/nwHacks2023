...
const getMetricsReportingUrl = async src => {
  try {
 ...
 */
function addMediaMetricsToStore(store, sourceUrl, onError) {
...
exports.DEFAULT_AUTOHIDE_TIME = src.DEFAULT_AUTOHIDE_TIME;
exports.DEFAULT_VOLUME_LEVEL = src.DEFAULT_VOLUME_LEVEL;
exports.createControllerStore = src.createControllerStore;
exports.getMediaSourceType = src.getMediaSourceType;
