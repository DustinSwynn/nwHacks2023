...
export declare function LivepeerConfig<TLivepeerProvider extends LivepeerProvider>({ children, client, theme, dehydratedState, }: React.PropsWithChildren<LivepeerConfigProps<TLivepeerProvider>>): JSX.Element;
