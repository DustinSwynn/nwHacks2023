...
export declare function LivepeerConfig<TLivepeerProvider extends LivepeerProvider>({ children, client, dehydratedState, }: React.PropsWithChildren<LivepeerConfigProps<TLivepeerProvider>>): JSX.Element;
