...
export type AudioPlayerProps<TElement, TPoster> = Omit<HlsPlayerProps<TElement, TPoster>, 'src' | 'poster'> & {
    src: AudioSrc[];
};
export type VideoPlayerProps<TElement, TPoster> = Omit<HlsPlayerProps<TElement, TPoster>, 'src'> & {
    src: VideoSrc[] | null;
};
