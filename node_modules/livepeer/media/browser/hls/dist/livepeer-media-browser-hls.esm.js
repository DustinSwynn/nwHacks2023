import { b as _objectSpread2, _ as _asyncToGenerator, a as _regeneratorRuntime } from '../../../../dist/asyncToGenerator-663536dc.esm.js';
import 'core-js/modules/es.object.to-string.js';
import 'core-js/modules/es.promise.js';
import Hls, { Events, ErrorTypes } from 'hls.js';
import { i as isClient } from '../../../../dist/utils-11c7a7d0.esm.js';
...
var isHlsSupported = function isHlsSupported() {
  return isClient() ? Hls.isSupported() : true;
};
...
var createNewHls = function createNewHls(source, element, callbacks, config) {
  ...
  hls.on(Events.LEVEL_LOADED, /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_e, data) {
  ...
  hls.on(Events.MEDIA_ATTACHED, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            hls.loadSource(source);
            hls.on(Events.MANIFEST_PARSED, function (_event, _data) {
              ...
              if (config !== null && config !== void 0 && config.autoplay && element) {
                try {
                  element.muted = true;
                } catch (e) {
  ...
  var retryCount = 0;
  hls.on(Events.ERROR, /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(_event, data) {
      var _callbacks$onError;
      var type, details, fatal, isFatalNetworkError, isFatalMediaError, isManifestParsingError;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              type = data.type, details = data.details, fatal = data.fatal;
              isFatalNetworkError = type === ErrorTypes.NETWORK_ERROR && fatal;
              isFatalMediaError = type === ErrorTypes.MEDIA_ERROR && fatal;
              isManifestParsingError = ErrorTypes.NETWORK_ERROR && details === 'manifestParsingError';
...
export { VIDEO_HLS_INITIALIZED_ATTRIBUTE, createNewHls, isHlsSupported };
