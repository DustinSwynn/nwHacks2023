...
var createNewHls = function createNewHls(source, element, callbacks, config) {
  ...
  var hls = new Hls__default["default"](asyncToGenerator._objectSpread2({
    maxBufferLength: 15,
  ...
  hls.on(Hls.Events.LEVEL_LOADED, /*#__PURE__*/function () {
  ...
  hls.on(Hls.Events.MEDIA_ATTACHED, /*#__PURE__*/asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee2() {
  ...
  var retryCount = 0;
  hls.on(Hls.Events.ERROR, /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              isFatalNetworkError = type === Hls.ErrorTypes.NETWORK_ERROR && fatal;
              isFatalMediaError = type === Hls.ErrorTypes.MEDIA_ERROR && fatal;
              isManifestParsingError = Hls.ErrorTypes.NETWORK_ERROR && details === 'manifestParsingError';
