import { createStorage } from '@livepeer/core';
import { DEFAULT_VOLUME_LEVEL, DEFAULT_AUTOHIDE_TIME, addMediaMetricsToStore, createControllerStore } from '@livepeer/core/media';
...
function addMediaMetricsToInitializedStore(store, sourceUrl, onError) {
  ...
  var _addMediaMetricsToSto = addMediaMetricsToStore(store, sourceUrl, onError),
...
export { addEventListeners, addMediaMetrics, addMediaMetricsToInitializedStore, getDeviceInfo, isPictureInPictureSupported };
