...
var enterPictureInPicture = /*#__PURE__*/function () {
  var _ref = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee(inputElement) {
...
var getPictureInPictureMode = function getPictureInPictureMode(element) {
  if (utils.isClient() && element instanceof HTMLVideoElement) {
...
var allKeyTriggers = ['KeyF', 'KeyK', 'KeyM', 'KeyI', 'Space', 'ArrowRight', 'ArrowLeft'];
...
var getIsVolumeChangeSupported = function getIsVolumeChangeSupported(element) {
  return new Promise(function (resolve) {
    var _element$volume;
    var prevVolume = (_element$volume = element === null || element === void 0 ? void 0 : element.volume) !== null && _element$volume !== void 0 ? _element$volume : media.DEFAULT_VOLUME_LEVEL;
    var newVolume = prevVolume - 0.01;
...
var addEventListeners = function addEventListeners(store) {
  ...
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
    ...
    autohide = _ref$autohide === void 0 ? media.DEFAULT_AUTOHIDE_TIME : _ref$autohide;
  var element = store === null || store === void 0 ? void 0 : (_store$getState = store.getState()) === null || _store$getState === void 0 ? void 0 : _store$getState._element;
  ...
  store.setState({
    muted: element === null || element === void 0 ? void 0 : element.muted
  });
  ...
  var onTouchUpdate = /*#__PURE__*/function () {
    var _ref3 = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee2() {
  ...
  var onError = /*#__PURE__*/function () {
    var _ref4 = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee3(e) {
  ...
  var onWaiting = /*#__PURE__*/function () {
    var _ref5 = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee4() {
  ...
  var onStalled = /*#__PURE__*/function () {
    var _ref6 = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee5() {
  ...
  var onLoadStart = /*#__PURE__*/function () {
    var _ref7 = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee6() {
  ...
  var onResize = /*#__PURE__*/function () {
    var _ref8 = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee7() {
      return asyncToGenerator._regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              store.getState().setSize(asyncToGenerator._objectSpread2(asyncToGenerator._objectSpread2({}, element !== null && element !== void 0 && element.videoHeight && element !== null && element !== void 0 && element.videoWidth ? {
                media: {
  ...
  // add effects
  var removeEffectsFromStore = addEffectsToStore(store, element, {
    autohide: autohide
  });
  ...
  return {
    destroy: function destroy() {
      var _element$removeEventL, _element$removeEventL2, _element$removeEventL3, _element$removeEventL4, _element$removeEventL5, _element$removeEventL6, _element$removeEventL7, _element$removeEventL8, _element$removeEventL9, _element$removeEventL10, _element$removeEventL11, _element$parentElemen2, _parentElementOrEleme, _parentElementOrEleme2, _parentElementOrEleme3, _parentElementOrEleme4, _parentElementOrEleme5, _parentElementOrEleme6, _parentElementOrEleme7, _store$destroy, _element$removeAttrib;
      ...
      element === null || element === void 0 ? void 0 : (_element$removeEventL2 = element.removeEventListener) === null || _element$removeEventL2 === void 0 ? void 0 : _element$removeEventL2.call(element, 'canplay', onCanPlay);
      ...
      var parentElementOrElement = (_element$parentElemen2 = element === null || element === void 0 ? void 0 : element.parentElement) !== null && _element$parentElemen2 !== void 0 ? _element$parentElemen2 : element;
...
var previousPromise;
var addEffectsToStore = function addEffectsToStore(store, element, options) {
  // add effects to store changes
  return store.subscribe( /*#__PURE__*/function () {
    var _ref9 = asyncToGenerator._asyncToGenerator( /*#__PURE__*/asyncToGenerator._regeneratorRuntime().mark(function _callee8(current, prev) {
      var _store$getState2, device, isFullscreen, isPictureInPicture;
          ...
          switch (_context8.prev = _context8.next) {
            ...
            case 11:
              ...
              if (current.muted !== prev.muted) {
                ...
                if (current.volume === 0) {
                  element.volume = media.DEFAULT_VOLUME_LEVEL;
                }
              }
            ...
            case 21:
              if (current._requestedFullscreenLastTime !== prev._requestedFullscreenLastTime) {
                isFullscreen = isCurrentlyFullscreen(element);
                if (!isFullscreen) {
              ...
              if (current._requestedPictureInPictureLastTime !== prev._requestedPictureInPictureLastTime) {
                isPictureInPicture = isCurrentlyPictureInPicture(element);
...
var VIDEO_METRICS_INITIALIZED_ATTRIBUTE = 'data-metrics-initialized';
 ...
 */
function addMediaMetricsToInitializedStore(store, sourceUrl, onError) {
  var defaultResponse = {
    metrics: null,
    destroy: function destroy() {
      //
  ...
  var _addMediaMetricsToSto = media.addMediaMetricsToStore(store, sourceUrl, onError),
 ...
 */
function addMediaMetrics(element, sourceUrl, onError, opts) {
  var store = media.createControllerStore({
    element: element !== null && element !== void 0 ? element : null,
    device: getDeviceInfo(),
    storage: core.createStorage(typeof window !== 'undefined' ? {
  ...
  var _addMediaMetricsToIni = addMediaMetricsToInitializedStore(store, sourceUrl, onError),
    metrics = _addMediaMetricsToIni.metrics,
    destroyMetrics = _addMediaMetricsToIni.destroy;
  return {
    metrics: metrics,
    destroy: function destroy() {
      var _store$destroy;
...
exports.canPlayMediaNatively = utils.canPlayMediaNatively;
exports.addEventListeners = addEventListeners;
exports.addMediaMetrics = addMediaMetrics;
exports.addMediaMetricsToInitializedStore = addMediaMetricsToInitializedStore;
exports.getDeviceInfo = getDeviceInfo;
exports.isPictureInPictureSupported = isPictureInPictureSupported;
